...
const Actions: React.FC<ActionsProps> = ({ setMenuMobile }) => {
  ...
  return (
    <div className="actions flex items-center gap-8">
      ...
      <Link className="link flex text-white duration-250 rounded-full p-2 hover:bg-[#5865F2]" href={_discordUrl}>
        <svg className="icon fill-current" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          <title>Discord</title>
